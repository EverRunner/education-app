...
/// 单词卡（中英）
class StudyWordChEnPage extends StatefulWidget {
  /// 课程id
  late int courseId;
  ...
  StudyWordChEnPage(this.courseId, this.chapterId, this.isReviewWordTest,
      this.isReview, this.courseType,
      {Key? key})
      : super(key: key);

  @override
  State<StudyWordChEnPage> createState() => _StudyWordChEnPageState();
}

class _StudyWordChEnPageState extends State<StudyWordChEnPage> {
  /// 课程章节详情信息
