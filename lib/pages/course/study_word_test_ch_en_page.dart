...
/// 关键词测试（中英）
class StudyWordTestChEnPage extends StatefulWidget {
  /// 课程id
  late int courseId;
  ...
  StudyWordTestChEnPage(this.courseId, this.chapterId, this.isReviewWordTest,
      this.isReview, this.courseType,
      {Key? key})
      : super(key: key);

  @override
  State<StudyWordTestChEnPage> createState() => _StudyWordTestChEnPageState();
}

class _StudyWordTestChEnPageState extends State<StudyWordTestChEnPage> {
  /// 关键词测试
